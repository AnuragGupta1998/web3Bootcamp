...
function TokenLaunchpad() {
  return (
    <div className='flex flex-col  h-screen w-full items-center bg-black gap-2 rounded-b-xl'>
        <h1 className='text-4xl font-bold font-mono mb-10 shadow-xl text-blue-300 underline  '> Solana Token Launchpad</h1>
        ...
        <button type="button" className='bg-blue-200 p-4 mt-14 rounded-full text-xl font-bold hover:bg-blue-600'> create a token</button>
